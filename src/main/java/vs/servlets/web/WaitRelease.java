...
public class WaitRelease extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String query = "select id, servicename from waitingmessageidweb";
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String query = "delete from waitingmessageidweb";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!ids.isEmpty()) {
			...
			for (String id : ids) {
				...
				Runnable r1 = () -> WebSVMap.removeWaitingMessageId(idx);
				WebSVMap.submit(r1);
			}
			...
			response.getWriter().append("<dmsv-status>")
					.append("ERROR: <dmsv-message-id> tags are mandatory in the request body").append("</dmsv-status>");
